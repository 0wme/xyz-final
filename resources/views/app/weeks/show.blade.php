                        ...
                        <div class="details">
                            ...
                            <div class="metadata">
                                ...
                                <div class="metadata-item">
                                    ...
                                    <span>{{ $track->category->name ?? 'Aucune catégorie' }}</span> <!-- Aucune Catégorie c'est pour les musiques qui étaient la avant la mise en place de la catégorie que j'ai modifié après. -->
                                </div>
